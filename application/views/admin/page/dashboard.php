...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
    ...
    <div class="col-lg-12">
        <div class="alert alert-danger alert-dismissible fade in" role="alert">
            <h4 id="oh-snap!-you-got-an-error!"><?= $this->lang->line("note_lbl") ?>:<a class="anchorjs-link"
                    href="#oh-snap!-you-got-an-error!"><span class="anchorjs-icon"></span></a></h4>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <a href="<?= site_url('admin/sub-category') ?>" title="<?= $sub_cat_cnt ?>"
            class="card card-banner card-yellow-light">
            <div class="card-body"> <i class="icon fa fa-sitemap fa-4x"></i>
                <div class="content">
                    <div class="title"><?= $this->lang->line('sub_category_lbl') ?></div>
                    <div class="value"><span class="sign"></span><?php echo $ci->number_format_short($sub_cat_cnt); ?>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <a href="<?= site_url('admin/products') ?>" title="<?= $product_cnt ?>"
            class="card card-banner card-pink-light">
            <div class="card-body"> <i class="icon fa fa-product-hunt fa-4x"></i>
                <div class="content">
                    <div class="title"><?= $this->lang->line('products_lbl') ?></div>
                    <div class="value"><span class="sign"></span><?php echo $ci->number_format_short($product_cnt); ?>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="<?= site_url('admin/users') ?>" title="<?= $user_cnt ?>" class="card card-banner card-blue-light">
            <div class="card-body"> <i class="icon fa fa-users fa-4x"></i>
                <div class="content">
                    ...
                    <div class="value"><span class="sign"></span><?php echo $ci->number_format_short($user_cnt); ?>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="<?= site_url('admin/orders') ?>" title="<?= $order_cnt ?>" class="card card-banner card-orange-light">
            <div class="card-body"> <i class="icon fa fa-cart-arrow-down fa-4x"></i>
                <div class="content">
                    ...
                    <div class="value"><span class="sign"></span><?php echo $ci->number_format_short($order_cnt); ?>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <a href="<?= site_url('admin/transactions') ?>" title="<?= $transaction_cnt ?>"
            class="card card-banner card-alicerose-light">
            <div class="card-body"> <i class="icon fa fa-list fa-4x"></i>
                <div class="content">
                    <div class="title"><?= $this->lang->line('transactions_lbl') ?></div>
                    <div class="value"><span
                            class="sign"></span><?php echo $ci->number_format_short($transaction_cnt); ?></div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <a href="<?= site_url('admin/refunds') ?>" title="<?= $pending_refund_cnt ?>"
            class="card card-banner card-aliceblue-light">
            <div class="card-body"> <i class="icon fa fa-undo fa-4x"></i>
                <div class="content">
                    <div class="title"><?= $this->lang->line('refunds_lbl') ?></div>
                    <div class="value"><span
                            class="sign"></span><?php echo $ci->number_format_short($pending_refund_cnt); ?></div>
                </div>
            </div>
        </a>
    </div>

    <!--Tambahan Fitur Raja Ongkir-->
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <a href="<?= site_url('admin/rajaongkir') ?>" title="Raja Ongkir" class="card card-banner card-pink-light">
            <div class="card-body"> <i class="icon fa fa-rocket fa-4x"></i>
                <div class="content">
                    <div class="title">Raja Ongkir</div>
                    <div class="value"><span class="sign"></span><?php echo 3; ?></div>
                </div>
            </div>
        </a>
    </div>
        ...
        <div class="container-fluid" style="background: #FFF;box-shadow: 0px 5px 10px 0px #CCC;border-radius: 2px;">
            ...
            <div class="col-lg-2" style="padding-top: 20px">
                <form method="get" id="graphFilter2">
                    <select class="form-control select2" name="order_filter"
                        ...
                        ?>
                        <option value="<?= $i ?>"
                            <?= (isset($_GET['order_filter']) && $_GET['order_filter'] == $i) ? 'selected' : '' ?>>
                            <?= $i ?></option>
                        <?php
                        }
                        ?>
            ...
            <div class="col-lg-12">
                ...
                ?>
                <div id="ordersChart">
                    <p style="text-align: center;"><i class="fa fa-spinner fa-spin"
                            style="font-size:3em;color:#aaa;margin-bottom:50px" aria-hidden="true"></i></p>
                </div>
                <?php
                }
                ?>
        ...
        <div class="container-fluid" style="background: #FFF;box-shadow: 0px 5px 10px 0px #CCC;border-radius: 2px;">
            ...
            <div class="col-lg-2" style="padding-top: 20px">
                <form method="get" id="graphFilter">
                    <select class="form-control select2" name="transaction_filter"
                        style="box-shadow: none;height: auto;border-radius: 0px;font-size: 16px;">
                        <?php
                        $currentYear = date('Y');
                        $minYear = 2019;
                        ...
                        ?>
                        <option value="<?= $i ?>"
                            <?= (isset($_GET['transaction_filter']) && $_GET['transaction_filter'] == $i) ? 'selected' : '' ?>>
                            <?= $i ?></option>
                        <?php
                        }
                        ?>
...
<div class="row card_item_block" style="padding-left: 30px;padding-right: 30px">
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
        <div class="card card-mini">
            <div class="card-header">
                <div class="card-title"><?= $this->lang->line('top_sales_products_lbl') ?> <a
                        href="<?php if (!empty($top_selling_products)) {
                                                                                                        echo site_url('admin/top-sale-products');
                                                                                                    } else {
                                                                                                        echo 'javascript:void(0)';
                                                                                                    } ?>">[<?= $this->lang->line('view_all_lbl') ?>]</a></div>
    ...
    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
        <div class="card card-mini">
            <div class="card-header">
                <div class="card-title"><?= $this->lang->line('todays_ord_lbl') ?> <a
                        href="<?php if (!empty($todays_orders)) {
                                                                                                echo site_url('admin/orders');
                                                                                            } else {
                                                                                                echo 'javascript:void(0)';
                                                                                            } ?>">[<?= $this->lang->line('view_all_lbl') ?>]</a></div>
                <ul class="card-action">
            ...
            <div class="card-body no-padding table-responsive">
                <table class="table card-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><a href="<?php echo site_url("admin/orders/" . $value->order_unique_id); ?>"
                                    target="_blank"><?= $value->order_unique_id ?></a></td>
                            <td class="right"><?= $value->name ?></td>
                            <td class="right"><?= CURRENCY_CODE . ' ' . $value->payable_amt ?></td>
                            <td><span class="badge <?= $_bnt_class ?> badge-icon"><i class="<?= $_btn_icon ?>"
                                        aria-hidden="true"></i><span><?= $_btn_title ?></span></span></td>
                        </tr>
                        <?php }
                        } else { ?>
                        <tr>
