    ...
    <div class="col-xs-12">
                ...
                <div class="col-md-6 col-md-offset-1 col-xs-12">
                    <div class="col-sm-12">
                        <div class="search_list">
                            <div class="search_block">
                                <form method="get" action="">
                                    <input class="form-control input-sm"
                                        placeholder="<?=$this->lang->line('search_lbl')?>"
                            ...
                            <div class="add_btn_primary"> <a
                                    href="<?php echo site_url("admin/category/add");?>?redirect=<?=$redirectUrl?>"><?=$this->lang->line('add_new_lbl')?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        ?>
          ...
          ?>
                  ...
                  {
                ?>
                                <a href="" data-id="<?php echo $row->id;?>" class="btn_status" data-status="0"
                                    data-toggle="tooltip" data-tooltip="<?=$this->lang->line('remove_to_home_lbl')?>"
                                    style="width: 30px;height: 30px;z-index: 1">
                                    <div style="color:green;"><i class="fa fa-home"></i></div>
                                </a>
                                <?php 
                  }
                  else{
                    ?>
                                <a href="javascript:void(0)" data-id="<?php echo $row->id;?>" class="btn_status"
                                    data-status="1" data-toggle="tooltip"
                                    data-tooltip="<?=$this->lang->line('show_on_home_lbl')?>"
                                    style="width: 30px;height: 30px;z-index: 1">
                ...
                ?>
                  ...
                  {
                ?>
                                <a href="javascript:void(0)" data-type="category" data-sub_id="0"
                                    data-title="<?php echo $row->category_name;?>" data-id="<?php echo $row->id;?>"
                                    data-image="<?=($row->category_image!='') ? IMG_PATH.$row->category_image : ''?>"
                                    class="btn_notification" data-toggle="tooltip"
                                    data-tooltip="<?=$this->lang->line('send_notification_lbl')?>"
                                    style="width: 30px;height: 30px;z-index: 1;margin-right: 5px">
                            ...
                            <div class="wall_image_title">
                                <h2><a href="<?php echo site_url("admin/category/edit/".$row->id);?>?redirect=<?=$redirectUrl?>"
                                        title="<?=$row->category_name?>"
                                        style="text-shadow: 1px 1px 1px #000;font-size: 16px">
                                        <?php 
                  ...
                  ?>
                                ...
                                <ul>
                                    <li><a href="<?php echo site_url("admin/category/edit/".$row->id);?>?redirect=<?=$redirectUrl?>"
                                            data-toggle="tooltip" data-tooltip="<?=$this->lang->line('edit_lbl')?>"><i
                                                class="fa fa-edit"></i></a></li>
                                    <li><a href="" data-toggle="tooltip" class="btn_delete_a" data-id="<?=$row->id?>"
                                            data-tooltip="<?=$this->lang->line('delete_lbl')?>"><i
                                                class="fa fa-trash"></i></a></li>
                                    <li>
                                        <div class="row toggle_btn">
                                            <input type="checkbox" id="enable_disable_check_<?=$i?>"
                                                data-id="<?=$row->id?>" class="cbx hidden enable_disable"
                  ...
                  if(file_exists(IMG_PATH.$row->category_image) || $row->category_image==''){
                    ?>
                                <img src="https://via.placeholder.com/247x150?text=No image"
